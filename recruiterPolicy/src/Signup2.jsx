            ...
            <section id="signup2_page" >
                <div id="signup2_page_text">
                    ...
                    <div id="form">
                        ...
                        <br />
                        <br />
                        <div style={{ display: "flex", alignItems: "center" }}><Checkbox onClick={() => { flag1 = !flag1 }} style={{ width: "25px", height: "25px", marginRight: "5px", color: "#0063ff" }} /><p style={{ color: "rgb(75,75,75)" }}>I agree to the <a href="https://www.thesocialcomment.com/company/terms-of-services">Terms of Service</a> and <a href="https://www.thesocialcomment.com/company/privacy-policy">Privacy Policy</a></p></div>
                        <div style={{ display: "flex", alignItems: "center" }} ><Checkbox onClick={() => { flag2 = !flag2 }} style={{ width: "25px", height: "25px", marginRight: "5px", color: "#0063ff" }} /><p style={{ color: "rgb(75,75,75)" }}>I have read the <NavLink exact to="/terms-for-recruiters">Recruiter Policy</NavLink></p></div>
                        <br />
                        <br />
