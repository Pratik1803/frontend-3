...
import applicationProcedure from "../images/descriptionLinkImages/applicationProcedure.png";
        ...
        <section className="content_page" >
            <div className="content_page_wrapper" >
                ...
                <div className="content_page_text" >
                    ...
                    <br />
                    <ul>
                        <li>If you feel that you fulfill the eligibility criteria outlined in clause 3, you can apply to register for the Program by dropping us an email at our email address <a href="mailto:thesocialcomments@gmail.com">thesocialcomments@gmail.com</a>. Please note that your fulfillment of the eligibility criteria does not guarantee your registration with the program and we retain the right to reject your application even if you fulfill the eligibility criteria.</li>
