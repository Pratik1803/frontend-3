            ...
            <div className="content_page_wrapper" >
                ...
                <div className="content_page_text" >
                    ...
                    <ul>
                        ...
                        <h3>We may terminate this Policy by removing you from the Program if: </h3>
                        ...
                        <h3>Additionally, we reserve the right to terminate this Policy by removing you from the Program for any or no reason. If we decide to terminate this Policy and remove you from the Program, we shall send you a notice of termination and this Policy will stand terminated and you shall stand removed from the Program on the date you receive such notice.</h3>
